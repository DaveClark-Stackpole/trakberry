...
from views_production import two_hour,two_hour_comment, redirect_two_hour,two_hour_next,two_hour_past,two_hour_prev
...
#	url(r'^hour_check/', hour_check),
	...
	url(r'^two_hour_past/', two_hour_past),
	url(r'^two_hour_prev/', two_hour_prev),
	url(r'^two_hour_next/', two_hour_next),
